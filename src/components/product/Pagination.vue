<template>
  <div class="pagination-component">
    <ul v-show="totalPages > 1" class="pagination">
      ...
      <li :class="'page-item ' + activeClass(pageNum)" v-bind:key="pageNum" v-for="pageNum in totalPages">
...
export default {
  props: {
    ...
    countText: { type: String, default: 'Showing {from} to {to} of {count} products|{count} products|1 product'},
